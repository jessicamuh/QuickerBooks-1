...
namespace QuickerBooksApp.Extensions { 
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "QuickerBooksApp.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "QuickerBooksApp.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
